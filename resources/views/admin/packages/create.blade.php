...
@section('title', 'Tambah Paket Perjalanan')
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="d-flex align-items-center">
            ...
            <h2 class="mb-0">Tambah Paket Perjalanan</h2>
        </div>
    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('travel_partner_id') is-invalid @enderror" 
                                        ...
                                        @foreach($partners as $partner)
                                            <option value="{{ $partner->id }}" {{ old('travel_partner_id') == $partner->id ? 'selected' : '' }}>
                                                {{ $partner->name }}
                                            </option>
                                        @endforeach
                                    </select>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <!-- Setelah field agent_fee, tambahkan: -->
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('agent_fee_type') is-invalid @enderror" 
                                        ...
                                        <option value="fixed" {{ old('agent_fee_type') == 'fixed' ? 'selected' : '' }}>Nominal Tetap (Rp)</option>
        ...
        reader.onload = function(e) {
            preview.innerHTML = `
                <div class="mt-2">
                    ...
                    <p class="small text-muted mt-1">Preview gambar yang akan diupload</p>
                </div>
            `;
        };
