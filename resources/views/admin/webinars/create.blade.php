        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Tambah Webinar Baru</h3>
                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('speaker') is-invalid @enderror" 
                                           id="speaker" name="speaker" value="{{ old('speaker') }}">
                                    @error('speaker')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('template') is-invalid @enderror" 
                                        ...
                                        <option value="webinar" {{ old('template') == 'webinar' ? 'selected' : '' }}>Template Webinar</option>
                                        <option value="webinardua" {{ old('template') == 'webinardua' ? 'selected' : '' }}>Template Webinar Dua</option>
                                    </select>
                                    @error('template')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
