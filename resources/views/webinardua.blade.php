...
<body class="bg-gray-50">
    <div class="min-h-screen">
        ...
        <div class="bg-gradient-to-r from-[#D4AF37] to-[#FFD700] py-12 md:py-20">
            <div class="container mx-auto px-4 max-w-4xl">
                <h1 class="font-playfair text-3xl md:text-5xl lg:text-6xl font-bold text-gray-900 text-center mb-6 leading-tight">
                    Mau Tau Langkah Pertama ke Mekkah Sebagai Tour Leader Umroh?
                </h1>
                ...
                <div class="bg-white/30 p-6 rounded-lg mb-8 text-gray-800">
                    ...
                    <div class="space-y-3">
                        <p class="font-medium">✅ Peta karir Tour Leader</p>
                        <p class="font-medium">✅ Skill WAJIB Tour Leader</p>
                        <p class="font-medium">✅ Cara mengelola perjalanan umroh</p>
                        <p class="font-medium">✅ Tips Sukses sebagai Tour Leader</p>
                    </div>
                </div>

                <div class="bg-white/30 p-6 rounded-lg mb-8 text-gray-800">
                    <p class="font-bold mb-4">🎉 Webinar Gratis - First Step to Mekkah (Peta Karir & Skill Wajib Tour Leader)</p>
                    <p class="font-medium">📅 Sabtu, 31 Mei 2025</p>
                ...
                <div class="text-gray-800 mb-8">
                    ...
                    <div class="space-y-2 bg-white/30 p-6 rounded-lg">
                        <p class="font-medium">Bayangkan... Anda bisa langsung action, bisa ibadah, bantu sesama, dan pulang bawa rezeki.</p>
                ...
                <div class="text-center">
                    <a href="#" 
                       onclick="document.getElementById('formModal').classList.add('show')"
        ...
        <div id="daftar" class="container mx-auto px-4 py-16">
            <!-- Move modal outside the #daftar div -->
            <div id="formModal" class="modal">
                <div class="max-w-md mx-auto bg-white rounded-xl shadow-lg p-4 m-4 relative">
                    <!-- Close button -->
                    <button type="button" 
                            onclick="document.getElementById('formModal').classList.remove('show')" 
                    ...
                    <h2 class="font-playfair text-xl font-bold text-center mb-3">Buku Tamu</h2>
